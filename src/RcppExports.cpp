...
RcppExport SEXP _partition_arma_kmeans(SEXP xSEXP, SEXP kSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _partition_pearson_distance(SEXP xSEXP, SEXP ySEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _partition_spearman_distance(SEXP xSEXP, SEXP ySEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type x(xSEXP);
...
RcppExport SEXP _partition_update_dist(SEXP reduced_distSEXP, SEXP cluster_nmSEXP, SEXP clust_var_nmsSEXP, SEXP reduced_dataSEXP, SEXP dist_typeSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _partition_assign_clusters(SEXP index_rSEXP, SEXP reduced_dist_rSEXP, SEXP reduced_data_rSEXP, SEXP data_rSEXP, SEXP pct_varSEXP, SEXP clusters_rSEXP, SEXP cluster_indSEXP, SEXP methodSEXP, SEXP dist_typeSEXP, SEXP new_varSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
